...
public class SerialInventoryBuilder {
    ...
    public static SerialInventoryBuilder builder() {return new SerialInventoryBuilder();}
    ...
    public SerialInventory build() {return new SerialInventory(serialKey, sku, lot, loc, quantity);}
}
